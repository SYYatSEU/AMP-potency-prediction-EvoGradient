...
class RCNN(nn.Module):
    ...
    def forward(self, x):
        ...
        out, _ = self.lstm(embed)  # [128 32 300]    [N 100 120]
        out = torch.cat((embed, out), 2)  # [128 32 812]   [N 100 140]
        out = F.relu(out)  # [128 32 812]  [N 100 60]
        out = out.permute(0, 2, 1)  # [128 812 32]   [N 140 100]
